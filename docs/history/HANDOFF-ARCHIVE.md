# Jungle — Session Handoff ARCHIVE (sessions 6–28)

_Split out of `SESSION-HANDOFF.md` in session 20, at commit `e81e793`. Sessions 24 and 25 moved
here in session 27; session 26 in session 28; session 27 in session 29; session 28 in session 30. The live file keeps the two most recent blocks, and
